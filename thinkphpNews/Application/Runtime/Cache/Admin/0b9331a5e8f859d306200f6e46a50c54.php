			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input value="<?php echo ($vo["url"]); ?>" type="text" class="form-control" name="url" id="inputPassword3" placeholder="无url地址">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input value="<?php echo ($vo["news_id"]); ?>" type="text" name="news_id" class="form-control" id="inputname" placeholder="无文章id">
						</div>
					</div>
					<div class="form-group">
